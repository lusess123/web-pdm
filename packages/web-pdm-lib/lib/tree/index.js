...
var OptionBuilder = function OptionBuilder(_ref) {
  ...
  var onShowMenu = (0, _react.useCallback)(function (val) {
    return function () {
      setShowMenu(val);
    };
  }, []);

  var menu = /*#__PURE__*/_react.default.createElement(_menu.default, null, options.map(function (option) {
  ...
  }, title), !!options.length && showMenu && /*#__PURE__*/_react.default.createElement(_dropdown.default, {
    overlay: menu
  }, /*#__PURE__*/_react.default.createElement("span", {
...
_tree.default['OptionBuilder'] = OptionBuilder;
