...
export const renderModelTitle = (title: string, searchValue: string, showNameOrLabel: boolean, originalKey: string) => {
...
const renderLabel = (isSpec: boolean, beforeStr: string, afterStr: string, searchValue: string) => {
