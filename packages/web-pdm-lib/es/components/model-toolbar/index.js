...
export default observer(({ graph }) => {
    ...
    return (React.createElement("div", { className: 'console-erd-toolbar' },
        React.createElement("div", { className: 'right' },
            React.createElement(ButtonActon, { key: 1, Tooltip: Tooltip, title: intl('撤销'), color: mst.Ui.darkness && undoManager.canUndo ? mst.Ui.themeColor : undefined, disable: !undoManager.canUndo, icon: React.createElement(RollbackOutlined, null), onClick: mst.undo.bind(mst) }),
            React.createElement(ButtonActon, { key: 2, Tooltip: Tooltip, title: intl('重做'), color: mst.Ui.darkness && undoManager.canRedo ? mst.Ui.themeColor : undefined, disable: !undoManager.canRedo, icon: React.createElement(RollbackOutlined, { style: { transform: 'scaleX(-1)' } }), onClick: mst.redo.bind(mst) }),
