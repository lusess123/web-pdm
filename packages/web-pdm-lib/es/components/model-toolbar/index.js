...
export default observer(({ graph }) => {
    ...
    return (React.createElement("div", { className: 'console-erd-toolbar' },
        React.createElement("div", { className: 'right' },
            ...
            React.createElement(ButtonActon, { IconRenders: _IconRenders, key: 5, Tooltip: Tooltip, title: intl('全景'), color: mst.Ui.darkness ? mst.Ui.themeColor : undefined, icon: 'container', onClick: mst.graph.container.bind(mst.graph, graph) }),
            ...
            React.createElement(ButtonActon, { IconRenders: _IconRenders, key: 9, Tooltip: Tooltip, title: intl('切换底色'), icon: mst.Ui.darkness ? (React.createElement(SnippetsFilled, null)) : (React.createElement(SnippetsOutlined, null)), color: mst.Ui.darkness ? mst.Ui.themeColor : undefined, onClick: mst.Ui.setDarkness.bind(mst.Ui, !mst.Ui.darkness) }),
            React.createElement(Popover, { placement: 'rightTop', arrowPointAtCenter: true, footer: null, content: React.createElement(SketchPicker, { color: mst.Ui.themeColor, onChange: setColor }), visible: colorPabel },
                React.createElement(ButtonActon, { IconRenders: _IconRenders, Tooltip: Tooltip, title: `${intl('点击')}${colorPabel ? intl('关闭') : intl('打开')} ${intl('颜色面板')}`, color: mst.Ui.themeColor, icon: colorPabel ? (React.createElement(CloseCircleFilled, null)) : (React.createElement(BgColorsOutlined, null)), onClick: setColorPabel.bind(null, !colorPabel) })))));
});
